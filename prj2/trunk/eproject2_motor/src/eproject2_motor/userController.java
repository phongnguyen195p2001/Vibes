...
public class userController {
    ...
    @FXML
    private TableView<?> tvmotor;

    @FXML
    private TableColumn<?, ?> tvname;

    @FXML
    private TableColumn<?, ?> tvusern;
    ...
    @FXML
    void btndb(MouseEvent event) throws IOException {
        Parent root
    ...
    void btnlogout(MouseEvent event) throws IOException {
        Parent root
                = FXMLLoader.load(getClass().getResource("logout.fxml"));
    ...
    @FXML
    void clickInsert(MouseEvent event) {
