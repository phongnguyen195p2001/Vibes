        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" style="float:right;">
            ...
            <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="admininfo.php"><em class="fa fa-user">&nbsp;</em> Thông tin quản trị</a></li>
            ...
            <div>
                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $watch_set = find_all_contact();
                            $count = mysqli_num_rows($watch_set);
                            for ($i = 0; $i < $count; $i++) :
                                $watch = mysqli_fetch_assoc($watch_set);
                            ?>
                                <tr>
                                    <td><?php echo $watch['user_name'] ?></td>
                                    <td><?php echo $watch['user_email'] ?></td>
                                    <td style="width: 100px;"><?php echo $watch['content'] ?></td>
                                    <td style="text-align: center;"><a style="color:#30a5ff;" href="<?php echo 'updatecontact.php?idcontact=' . $watch['idcontact']; ?>"><i class="fa fa-edit"></i></a></td>
                                    <td style="text-align: center;"><a style="color:#30a5ff;" href="<?php echo 'deletecontact.php?idcontact=' . $watch['idcontact']; ?>"><i class="fa fa-trash"></i></td>
                                </tr>
                            <?php
                            endfor;
