                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td style="height: 100px;width: 100px;"><img class="img-thumbnail" src="img/logo/<?php echo $brand['imagebr'] ?>"></td>
                                    <td><?php echo $brand['namebrand'] ?></td>
                                    <td style="text-align: center;"><a style="color:#30a5ff;" href="<?php echo 'updatebrand.php?idbrand=' . $brand['idbrand']; ?>"><i class="fa fa-edit"></i></a></td>
                                    <td style="text-align: center;"><a style="color:#30a5ff;" href="<?php echo 'deletebrand.php?idbrand=' . $brand['idbrand']; ?>"><i class="fa fa-trash"></i></td>
                                </tr>
                            <?php
                            endfor;
