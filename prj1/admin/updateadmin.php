...
<body>
    ...
    <div class="signup-form">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="form-group">
                <input type="password" class="form-control" name="password" placeholder="Password" value="<?php echo $admin['password'] ?>">
			</div>
			<div class="form-group">
                <input type="password" class="form-control" name="confirm_password" value="<?php echo $admin['password'] ?>" placeholder="Confirm Password" required="required">
            </div>  
            <div class="form-group">
                <input type="email" class="form-control" name="mail" value="<?php echo $admin['mail'] ?>">
            </div>    
            <div class="form-group">
