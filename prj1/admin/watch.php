...
<head>
	...
	<style>
        ...
        #dataTable_previous,a.paginate_button{
            margin:6px;
            color:black;
            padding:4px;
        }
			...
			<div class="table-responsive">
                <table id="dataTable" class="table" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <th class="th-sm">Name Watch
                        </th>
                        <th class="th-sm">Price
                        </th>
                        <th class="th-sm">Watch code
                        </th>
                        </th>
					...
					<tbody>
					<?php 
							$watch_set = join_watch_brand();
							$count = mysqli_num_rows($watch_set);
							for ($i = 0; $i < $count; $i++):
							$watch = mysqli_fetch_assoc($watch_set);
					?>
						<tr>
                            <td style="height: 100px;width: 100px;"><img class="img-thumbnail" src="img/<?php echo $watch['image'] ?>"></td>
                            <td><?php echo $watch['namewatchs'] ?></td>
                            <td><?php echo $watch['price'] ?></td>
                            <td><?php echo $watch['code'] ?></td>
                            <td style="width: 100px;"><?php echo $watch['descriptions'] ?></td>
                            <td><?php echo $watch['namebrand'] ?></td>
                            <td><?php echo $watch['namecategory'] ?></td>
						    <td style="text-align: center;"><a style="color:#30a5ff;" href="<?php echo 'update.php?idwatchs='.$watch['idwatchs']; ?>"><i class="fa fa-edit"></i></a></td>
						    <td style="text-align: center;"><a style="color:#30a5ff;" href="<?php echo 'delete.php?idwatchs='.$watch['idwatchs']; ?>"><i class="fa fa-trash"></i></td>
                        </tr>
					<?php 
							endfor; 
							mysqli_free_result($watch_set);
                    ?>
                    </tbody>
                    <tfoot>
                    <tr>
