        ...
        <div class="row">
            ...
            if (isset($_GET["search"])) {
                if (isset($_GET["idwatchs"])) {
                    $idwatchs = $_GET["idwatchs"];
                    $sql = "SELECT * FROM watchs WHERE idwatchs=" . $idwatchs;
                ...
                if (isset($_GET['submit'])) {
                    $data = $_GET['search'];
                    $sql = "SELECT * FROM  watchs WHERE namewatchs='$data'";
            ...
            ?>
                ...
                <div class="row" style="padding-bottom:100px;">
                    <article class="col-sm-12">
                        <div class="container row">
                            <img class=" col-md-6" style="width: 100%;height:100%;" src="admin/img/<?php echo $row['image']; ?>">
                            <div class="col-md-4" style="margin-left:10px; font-size:20px; font-family:Courier;">
                                <ul>
                                    <li><i class="fas fa-signature"></i> <?php echo "Name Watchs: " . $row['namewatchs']; ?></li>
                                    <li><i class="fas fa-dollar-sign"></i> <?php echo "Price: $" . $row['price']; ?></li>
                                    <li><i class="fas fa-barcode"></i> <?php echo "Code: " . $row['code']; ?></li>
                                    <li><i class="fas fa-audio-description"></i> <?php echo "Description: " . $row['descriptions']; ?></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 style="font-family: Courier;">RELATED PRODUCTS:</h2>
                        <hr>
                    </div>
                    <?php
                        ...
                        <div id="Library-show" class="col-md-3">
                            <div class="col-md-12">
                                <div id="Library" class="box-hover">
                                    <img class="" style="width:230px; height:190px;" src="admin/img/<?php echo $show['image']; ?>">
            ...
            <?php } else { ?>
                ...
                <div class="row" style="padding-bottom:100px;">
                    <article class="col-sm-12">
                        <div class="container row">
                            <img class=" col-md-6" style="width: 100%;height:100%;" src="admin/img/<?php echo $row[1]; ?>">
                            <div class="col-md-4" style="margin-left:10px; font-size:20px; font-family:Courier;">
                                <ul style="font-weight: bold; font-family: Courier;">
                                    <li><i class="fas fa-signature"></i> <?php echo "Name Watchs: " . $row[2]; ?></li>
                                    <li><i class="fas fa-dollar-sign"></i> <?php echo "Price: $" . $row[3]; ?></li>
                                    <li><i class="fas fa-barcode"></i> <?php echo "Code: " . $row[4]; ?></li>
                                    <li><i class="fas fa-audio-description"></i> <?php echo "Description: " . $row[5]; ?></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    ?>
                        <div id="Library-show" class="col-md-3">
                            <div style="margin-bottom: 20px;" class="col-md-12 card">
                                <div id="Library" class="box-hover">
                                    <img style="width:230px; height:190px;" src="admin/img/<?php echo $show['image']; ?>">
                                    <h3><a href="<?php echo "chitiet_watchs.php?idwatchs=" . $show["idwatchs"]; ?>"><button type="button" class="btn btn-primary">View Detail</button> </a></h3>
                                </div>
                                <p class="name"><?php echo $show['namewatchs']; ?></p>
                                <p class="name" style="color:rgb(247, 90, 90); text-align:center; margin-bottom:40px;">Price : $<?php echo $show['price']; ?></p>
