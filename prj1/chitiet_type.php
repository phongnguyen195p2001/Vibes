...
<body>
    ...
    <div class="container" id="container">
        <div class="row">
            <div class="col-md-12">
                <div class="title_mod">
                    <span> DETAIL TYPES </span>
                </div>
                <br>
            </div>
            <?php
            if (isset($_GET["idcategory"])) {
                $idbrand = $_GET["idcategory"];
                $brand = find_all_facturer_type($idbrand);
                $count = mysqli_num_rows($brand);
            }
            ?>
            <?php
                    ...
                    <div style="margin-bottom: 20px;" class="col-md-12 card">
                        <div id="Library" class="box-hover">
                            ...
                            <a href="<?php echo "chitiet_watchs.php?idwatchs=" . $show["idwatchs"]; ?>">
                                <img class="img-thumbnail" style="width:230px; height:190px;" src="admin/img/<?php echo $show['image']; ?>">
                        ...
                        <p style="text-align:center; font-family:Courier; font-weight: bold;"><?php echo $show['namewatchs']; ?></p>
                        <p style="color:rgb(247, 90, 90); text-align:center; margin-bottom:40px;font-weight: bold; font-family:Courier;"><?php echo "Price : $". $show['price']; ?></p>
                    </div>
                </div>
            <?php
            endfor;
